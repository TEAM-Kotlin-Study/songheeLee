...
package ddwu.mobile.week06.bmicalculator.databinding;
...
import ddwu.mobile.week06.bmicalculator.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull EditText heightEditText,
      @NonNull Button resultButton, @NonNull EditText weightEditText) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, heightEditText, resultButton,
          weightEditText);
    }
